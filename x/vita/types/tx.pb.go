...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_eeb155d8b81bc490, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_eeb155d8b81bc490, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "vita.vita.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "vita.vita.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("vita/vita/tx.proto", fileDescriptor_eeb155d8b81bc490) }

var fileDescriptor_eeb155d8b81bc490 = []byte{
	// 312 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x2a, 0xcb, 0x2c, 0x49,
	...
	0xec, 0x87, 0x08, 0xba, 0xf4, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/vita.vita.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vita.vita.Msg/UpdateParams",
	}
