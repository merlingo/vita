...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e7271977f57742ff, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e7271977f57742ff, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "vita.vita.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "vita.vita.QueryParamsResponse")
}

func init() { proto.RegisterFile("vita/vita/query.proto", fileDescriptor_e7271977f57742ff) }

var fileDescriptor_e7271977f57742ff = []byte{
	...
	0x1c, 0x06, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xc8, 0xf4, 0x36, 0x72, 0xb2, 0x01, 0x00,
	0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/vita.vita.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vita.vita.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "vita/vita/query.proto",
}
